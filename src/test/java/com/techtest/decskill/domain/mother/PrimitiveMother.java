...
public class PrimitiveMother {
    ...
    public static final LocalDateTime DEFAULT_LOWER_DATE = LocalDateTime.of(2149, Month.DECEMBER, 31, 23, 59);
    ...
    public static int getRandomInt() {
        return PrimitiveMother.getRandomInt(-DEFAULT_INT_LIMIT, DEFAULT_INT_LIMIT);
    }
    ...
    public static long getRandomLong() {
        return getRandomLong(-DEFAULT_LONG_LIMIT, DEFAULT_LONG_LIMIT);
    }
    ...
    public static double getRandomDouble() {
        return getRandomDouble(-DEFAULT_DOUBLE_LIMIT, DEFAULT_DOUBLE_LIMIT);
    }
